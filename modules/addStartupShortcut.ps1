...
{ 
  ...
  { 
    ...
    { 
      ...
      Else 
      { 
        $BasePath = "$env:USERPROFILE\AppData\Roaming\Microsoft\Windows" 
      } 
...
#Add-StartMenuShortcut -Name "Cmder" -Target "C:\Tools\Utilities\Cmder\Cmder.exe" -Folder "Cmder" -WorkingDirectory "C:\Tools" -Icon "C:\Tools\Utilities\Cmder\Cmder.exe" -IconIndex 0 -Description "Cmder Alternative Shell" -HotKey "CTRL+SHIFT+F1" -WindowStyle 1 -RelativePath "C:\Tools" -Force -Verbose -Debug
